  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={handleClose}>
        <div className="bg-white text-stone-700 dark:bg-stone-900 dark:text-stone-100 rounded-lg p-2 -z-20">
          <div className="flex justify-between pb-2">
            ...
            <button
              type="button"
              className="rounded-full p-2  hover:bg-stone-200 text-stone-400 hover:text-stone-500 focus:outline-none"
              onClick={() => handleClose()}
            >
          ...
          <div className="flex justify-between">
            ...
            >
              ...
              <div className="mt-10 -ml-4 p-1 rounded-full border dark:bg-stone-900/60 bg-white/70">
          ...
          <div className="flex m-4">
            <button
              ...
              className={classNames(
                ...
                "text-center  py-2 text-sm font-medium w-1/2 border rounded-l-2xl"
              )}
            >
              Profile
            </button>
            <button
              ...
              className={classNames(
                editProfile === "settings"
                  ? "bg-stone-700 text-stone-100"
                  : "text-gray-600 hover:bg-stone-500 hover:text-stone-100 cursor-pointer",
                "text-center  py-2 text-sm font-medium w-1/2 border rounded-r-2xl"
              )}
            >
              Settings
            </button>
