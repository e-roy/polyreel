    ...
    <div className="bg-sky-600 text-xl sm:text-2xl">
      <div className="bg-gradient-to-t from-sky-900 to-sky-900/50 py-16  font-medium">
        <div className="sm:flex mx-auto justify-center sm:mx-16 my-16 ">
          <div className="sm:w-1/2 text-center">
            ...
            <div className="border mx-4 p-4 rounded-xl shadow-xl bg-sky-800/50 text-stone-100">
              ...
              collaborative one for all apps built on the Lens Protocol.
            </div>
          </div>
        </div>
        ...
        <div className="sm:flex mx-4 sm:mx-16 my-16">
          <div className="sm:w-1/2 text-center">
            <div className="border p-4 rounded-xl shadow-xl bg-sky-800/50 text-stone-100">
              Your profiles can be accessed by any application built on top of
              Lens Protocol.
            </div>
          </div>
        ...
        <div className="sm:flex mx-4 sm:mx-16 my-16">
          ...
          <div className="sm:w-1/2 text-center">
            <div className="border p-4 rounded-xl shadow-xl bg-sky-800/50 text-stone-100">
              your same followers and those following you can be seen on any
        ...
        <div className="sm:flex mx-4 sm:mx-16 my-16">
          <div className="sm:w-1/2 text-center">
            <div className="border p-4 rounded-xl shadow-xl bg-sky-800/50 text-stone-100">
              it's your information, no longer controlled by any app, but now by
              you, the user.
            </div>
          </div>
          <div className="sm:w-1/2"></div>
        ...
        <div className="sm:flex mx-4 sm:mx-16 my-16">
          ...
          <div className="sm:w-1/2 text-center">
            <div className="border p-4 rounded-xl shadow-xl bg-sky-800/50 text-stone-100">
              and you as the user, choice the experience you want by the apps
              you choose to use that are built on top of the Lens Protocol.
            </div>
          </div>
        </div>
      </div>
